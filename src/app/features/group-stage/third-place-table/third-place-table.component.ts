    ...
    <div class="bg-indigo-950/40 backdrop-blur-xl border border-indigo-500/30 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300">
      ...
      <div class="overflow-x-auto grow">
        <table class="w-full text-sm text-left">
          <thead class="text-[10px] uppercase bg-indigo-950/60 text-indigo-300 tracking-wider whitespace-nowrap">
            <tr>
              <th scope="col" class="pl-2 pr-1 sm:px-4 py-3 font-bold">Pos</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold">Grp</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold w-full">Team</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold text-center">P</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold text-center">W</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold text-center hidden sm:table-cell">D</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold text-center hidden sm:table-cell">L</th>
              <th scope="col" class="px-1 sm:px-2 py-3 font-bold text-center">GD</th>
              <th scope="col" class="px-1 sm:px-4 py-3 font-black text-center text-indigo-400">Pts</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-indigo-900/30">
            ...
            <tr class="transition-colors hover:bg-indigo-800/40 group cursor-default"
              ...
              <td class="pl-2 pr-1 sm:px-4 py-3.5 font-mono font-medium text-indigo-300 text-xs relative">
              ...
              <td class="px-1 sm:px-4 py-3.5 text-center font-black text-lg text-slate-100 group-hover:text-cyan-300 transition-colors">{{ item.standing.points }}</td>
            </tr>
            </ng-container>
          </tbody>
        </table>
